...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(routes)/about` | `/(routes)/adult-disclaimer` | `/(routes)/cart` | `/(routes)/drawer` | `/(routes)/home` | `/(routes)/map` | `/(routes)/order` | `/(routes)/orders` | `/(routes)/search` | `/(routes)/select-sign` | `/(routes)/sign-in` | `/(routes)/sign-up` | `/(routes)/start` | `/(routes)/update-account` | `/(routes)/user` | `/(routes)/verify-account` | `/(routes)/welcome-intro` | `/_sitemap` | `/about` | `/adult-disclaimer` | `/cart` | `/drawer` | `/home` | `/map` | `/order` | `/orders` | `/search` | `/select-sign` | `/sign-in` | `/sign-up` | `/start` | `/update-account` | `/user` | `/verify-account` | `/welcome-intro`;
